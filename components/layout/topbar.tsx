      ...
      <div className="flex items-center gap-3">
        {!hideFilters && (
          <Select value={dateRange} onValueChange={(v) => setDateRange(v as "14d" | "30d")}>
            <SelectTrigger className="w-24 bg-white text-slate-700 border-slate-200">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        {/* Logout Button */}
        <Button variant="ghost" size="sm" onClick={handleLogout} className="gap-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100">
